...
runSimpleTestCase "../bin/mattc -e -o -exp Int(0) part_8/test_class.mc" "part_8/test_class (evaluator)"
runSimpleTestCase "part_8/test_class"     "part_8/test_class (binary)"
runSimpleTestCase "part_8/test_conv_opt"  "part_8/test_conv_opt "
runSimpleTestCase "part_8/test_class_opt" "part_8/test_class_opt (binary)"
printf "\n"
